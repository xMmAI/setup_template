...
* **Component Libraries:** 
    * **shadcn/ui** (Use these primitives as the base for all new React components.)
    * **Flutter UI** (Use for projects requiring high-fidelity, cross-platform UI components.)
* **Icons:** Lucide React
...
* **Buttons:** Primary actions must use the solid Primary color. Secondary actions should use the 'Ghost' or 'Outline' variants from shadcn/ui or equivalent Flutter widgets.
